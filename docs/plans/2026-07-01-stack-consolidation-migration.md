...
**Spec (2026-07-04): `docs/specs/2026-07-04-phase3-workspace-design.md`** — the brainstorm SUPERSEDED the all-shift-tile framing below: alerting is push-first with an audible contract, and the tile is call-scoped (opens on Answer, dies at hang-up). The spec's decision log D1–D11 is authoritative; bullets below amended to match.
...
- **Call tile** (call-scoped, spec D4): opens on the Answer gesture, guest-video-first for kiosk eye contact while in RustDesk, compact mute/hold/hang-up/911 + Room#/note, second-property ring banner, dies at hang-up. In-tab overlays stay authoritative and untouched (spec D2). Chrome/Edge SOP.
