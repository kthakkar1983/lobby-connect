...
| **UI/UX Stage 3 — remaining** | **States / motion / a11y / copy pass — NOT started.** The final UI/UX phase (all 3 surface repaints now shipped). Fresh-chat. Parent plan: `docs/plans/2026-06-07-ui-ux-polish-stages.md`. Also open: the **Solitude capital-W** font fix (filed as its own task — crossed-W reads as "V"; no OpenType alternate, decide swap-font vs accept). | — |
