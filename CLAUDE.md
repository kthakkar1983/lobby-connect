...
| **UI/UX** | **Visual polish — PLANNED, not started.** App is the barebones shadcn skeleton; staged plan (direction → tokens/primitives → per-surface Kiosk>Owner>Agent/Admin → states/motion/a11y). Do in a fresh chat, brainstorm direction first. Plan: `docs/plans/2026-06-07-ui-ux-polish-stages.md` | — |
