...
| **UI/UX Stage 2+** | **Per-surface polish (Kiosk > Owner > Agent/Admin) + states/motion/a11y/copy — NOT started.** Gate behind the page set freezing. Kiosk repaint absorbs the deferred `Connected`/`Ringing` hardcoded-hex cleanup. Do in a fresh chat. Plan: `docs/plans/2026-06-07-ui-ux-polish-stages.md` | — |
