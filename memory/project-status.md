...
**NEXT:** Phase 0 (merge the cap branch + tag), then Phase 1 (domain + DO box + Coolify + staging hosting + ops runbook). Carry-forward hygiene unchanged: temp guest-audio diagnostics on `main`, GitHub secret-scanning alert, first-call-audio cause not airtight.
